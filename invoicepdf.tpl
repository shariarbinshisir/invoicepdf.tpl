...
if (file_exists(ROOTDIR . '/logo.png')) {
    $logoFilename = 'logo.png';
} elseif (file_exists(ROOTDIR . '/logo.jpg')) {
    $logoFilename = 'logo.jpg';
}
$pdf->Image(ROOTDIR . '/' . $logoFilename, 15, 25, 75);
...
$paymethhtml = '<table width="100%" cellspacing="1" cellpadding="2" border="0">
    <tr height="30">
        <td width="33%" style="text-align:left;"><strong>bKash Merchant</strong><br><br>Please send payment to:<br />01799944731<br />Ref: #'.$invoicenum.'</td>
    <td width="34%" style="text-align:left;"><strong>Rocket</strong><br><br>Account Type: Personal<br>Account No: 01785427504<br>Ref: #'.$invoicenum.'</td>
    <td width="33%" style="text-align:left;"><strong>Credit Card or other Methods</strong><br><br>Please phone us with your card details to pay with Visa or Mastercard or send us mail for other methods which you wants.</td>
        </tr></table>';
